...
public class Main {
	public static void main(String[] args) {
		...
		shop.addProduct(new Phone("Nokia-g10", 10_000, "Nokia"), 1)
				...
				.addProduct(new Phone("Samsung-s20", 20_000, "Samsung"), 3)
		...
		System.out.println("Products with a price equal to or less than 5000: " + Arrays.toString(shop.getProducts(5_000)));
